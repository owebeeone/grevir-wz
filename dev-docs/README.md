...
- [ESP32-family Xtensa implementation and review policy](review-policies/Esp32.md)
- [ESP32 capability and ownership study](GrevirEsp32CapabilityStudy.md)
- [Serial-bus peripheral inventory and API questions](GrevirSerialBusCapabilityStudy.md)
