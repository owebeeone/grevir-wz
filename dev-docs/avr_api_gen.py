...
ARDUINO_CORES="C:\\Program Files (x86)\\Arduino\\hardware\\arduino\\avr\\cores\\arduino"
ARDUINO_AVR_DIR="C:\\Program Files (x86)\\Arduino\\hardware\\arduino\\avr"
ARDUINO_BOARDS="boards.txt"
ARDUINO_PLATFORM="platform.txt"
ARDUINO_VARIANTS="variants"
ARDUINO_AVR_GNU_DIR="C:\\Program Files (x86)\\Arduino\\hardware\\tools\\avr"
...
class CreateArduinoData:
    ...
    def writeMacrosOutput(self, macros_name, macros_output):
        ...
        for line in macros_output.split('\n'):
            ...
            if match:
                (macro_name, macro_value) = match.groups()
                kv[(len(macro_name), macro_name)] = line
